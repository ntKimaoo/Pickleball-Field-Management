...
public class schedule extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        fromCalendar.add(Calendar.DAY_OF_MONTH, week*7);
        Date fromDate = fromCalendar.getTime();
        String formattedFromDate = new SimpleDateFormat("MM-dd-yyyy").format(fromDate);
        Calendar toCalendar=Calendar.getInstance();
        toCalendar.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY);
        toCalendar.add(Calendar.DAY_OF_MONTH, week*7);
        toCalendar.add(Calendar.DAY_OF_MONTH, 7);
        Date toDate = toCalendar.getTime();
        String formattedToDate = new SimpleDateFormat("MM-dd-yyyy").format(toDate);
        request.setAttribute("rented", fdao.getRentField(formattedFromDate,formattedToDate , field));
