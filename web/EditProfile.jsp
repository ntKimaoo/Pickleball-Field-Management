                            ...
                            <div class="card mb-4">
                                ...
                                <form method="post" action="editprofile">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="fullname" value="${requestScope.profile.getFullName()}">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phone" value="${requestScope.profile.getPhone()}">
                                        </div>
                                    </div>                    
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="address" value="${requestScope.profile.getAddress()}">
                                        </div>
                                    </div>
