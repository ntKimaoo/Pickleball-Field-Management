                                ...
                                <div class="rd-navbar-nav-wrap">
                                    <div class="rd-navbar-mobile-scroll">
                                        ...
                                        <ul class="rd-navbar-nav">
                                            ...
                                            <li><a href="about-coach.html"><span>ĐẶT SÂN</span></a></li>
                                            ...
                                            <div class="container2">
                                                <div class="item2">
                                                    <form action="vnpayajax" id="frmCreateOrder" method="post">  
                                                        ...
                                                        <button type="submit" class="price">20,000 đ</button>
                                                    </form>
                                                </div>
                                                <div class="item2">
                                                    <form action="vnpayajax" id="frmCreateOrder" method="post">  
                                                        <input type="hidden" name="amount" value="50000">
                                                        <button type="submit" class="price">50,000 đ</button>
                                                    </form>
                                                </div>
                                                <div class="item2">
                                                    <form action="vnpayajax" id="frmCreateOrder" method="post">  
                                                        <input type="hidden" name="amount" value="100000">
                                                        <button type="submit" class="price">100,000 đ</button>
                                                    </form>
                                                </div>
                                                <div class="item2">
                                                    <form action="vnpayajax" id="frmCreateOrder" method="post">  
                                                        <input type="hidden" name="amount" value="200000">
                                                        <button type="submit" class="price">200,000 đ</button>
                                                    </form>
                                                </div>
                                                <div class="item2">
                                                    <form action="vnpayajax" id="frmCreateOrder" method="post">  
                                                        <input type="hidden" name="amount" value="500000">
                                                        <button type="submit" class="price">500,000 đ</button>
                                                    </form>
                                                </div>
                                                <div class="item2">
                                                    <form action="vnpayajax" id="frmCreateOrder" method="post">  
                                                        <input type="hidden" name="amount" value="1000000">
                                                        <button type="submit" class="price">1,000,000 đ</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
