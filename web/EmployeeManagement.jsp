                                ...
                                <form style="display: flex">
                                    <div class="head" style="margin-right: 20px">
                                        <select name="khuVuc" onchange="this.form.submit()">
                                            ...
                                            <c:forEach items="${listBase}" var="c">
                                                <option value="${c.getId()}"
                                                        ${param.khuVuc == c.getId() ? 'selected' : ''}>${c.getId()}. ${c.getAddress()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="head" style="margin-right: 20px">
                ...
                <div class="popup-content">
                    ...
                    <form id="staffForm" action="addnewstaff" method="POST">
                        ...
                        <select id="base" name="base">
                            <c:forEach items="${listBase}" var="b">
                                <option value="${b.getId()}">${b.getId()}. ${b.getAddress()}</option>
                            </c:forEach>
                        </select>
