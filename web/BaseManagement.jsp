                ...
                <div class="table-data">
                    <div class="order">
                        <div style="display: flex; align-items: center; justify-content: space-between">
                            ...
                            <div class="head">
                                <a href="addnewfield" style="background-color: #00aced;color: white;padding: 3px;border-radius: 10px">
                        ...
                        <table>
                            ...
                            <tbody>
                                <c:if test="${listbase!= null}">
                                    <c:forEach var="s" items="${listbase}">
                                        <tr>
                                            <td>${s.getId()}</td>
                                            <td>${s.getAddress()}</td>
                                            <td><a href="managebaseemployee?id=${s.getId()}">Employee</a></td>
                                            <td><a href="managebasefield?id=${s.getId()}">Field</a></td>
                                        </c:forEach>
                                    </c:if>
                            </tbody>
                        </table>
